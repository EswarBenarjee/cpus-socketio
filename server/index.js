...
// Entry point for cluster which will create workers
// Workers will take care of the socket.io handling
...
if (cluster.isMaster) {
  ...
  // redis-cli monitor
  io.adapter(
    io_redis({ host: "https://cpus-socketio-api.onrender.com", port: 6379 })
  );
